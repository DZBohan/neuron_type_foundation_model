...
import pandas as pd  # Only for friendlier output (optional)
...
# 1) Read (backed mode is more memory-efficient, only enough to access obs)
adata = ad.read_h5ad(PATH, backed="r")

# 2) Automatically detect "cluster/subtype" column
...
# 3b) Internal check within Cerebral cortex
